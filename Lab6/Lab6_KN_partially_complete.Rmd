...
summary(m63a) #view results P-value = < 2.2e-16
```
...
summary(correlation_prop_bact_ratio) #view results P-value = < 2.2e-16
```
...
#P-value = < 2.2e-16, I got the same results except the correlation is now negative.
```
